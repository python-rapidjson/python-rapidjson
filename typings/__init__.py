...
def dumps(
    ...
    *,
    ...
    number_mode: t.Optional[NumberMode],
    datetime_mode: t.Optional[DatetimeMode],
    uuid_mode: t.Optional[UUIDMode],
    bytes_mode: t.Optional[BytesMode],
    iterable_mode: t.Optional[IterableMode],
    mapping_mode: t.Optional[MappingMode],
...
def load(
    ...
    *,
    ...
    datetime_mode: t.Optional[DatetimeMode],
    uuid_mode: t.Optional[UUIDMode],
    parse_mode: t.Optional[ParseMode],
    chunk_size: t.Optional[int] = 65536,
    allow_nan: t.Optional[bool] = True,
) -> t.Any: ...
def loads(
...
class Encoder:
    ...
    def __init__(
        self,
        skip_invalid_keys: t.Optional[bool],
        ensure_ascii: t.Optional[bool],
        write_mode: t.Optional[WriteMode],
        indent: t.Optional[t.Union[int, str]],
        sort_keys: t.Optional[bool],
        number_mode: t.Optional[NumberMode],
        datetime_mode: t.Optional[DatetimeMode],
        uuid_mode: t.Optional[UUIDMode],
        bytes_mode: t.Optional[BytesMode],
